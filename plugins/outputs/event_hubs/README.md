...
[[outputs.event_hubs]]
  ...
  ## Compress event payload with GZip
  ## Default is no compression
  ## Ingestion property `Compression` is set to `GZip` for correct handling by event hub
  ## see: https://docs.microsoft.com/en-us/azure/data-explorer/ingest-data-event-hub-overview#ingestion-properties
